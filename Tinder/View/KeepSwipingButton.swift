...
class KeepSwipingButton: UIButton {
    ...
    override func draw(_ rect: CGRect) {
        ...
        maskPath.addPath(UIBezierPath.init(roundedRect: rect, cornerRadius: layer.cornerRadius).cgPath)
        maskPath.addPath(UIBezierPath.init(roundedRect: rect.insetBy(dx: 2, dy: 2), cornerRadius: layer.cornerRadius).cgPath)        
